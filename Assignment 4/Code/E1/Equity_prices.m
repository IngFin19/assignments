function [p_LHP,p_HP,p_KL] = Equity_prices(corr,p,Ku,recovery,Is)
...
%  _ EquityKL_Vasicek = Equity KL price for the Vasicek model
...
for i=1:length(Is)
    ...
    p_KL(i) = Equity_KL_Vasicek(corr,p,Ku,recovery,Is(i));
end
