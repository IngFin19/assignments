function Xc   = certificatePricingBlack(certificate, rateCurve, cSelect)
%certificatePricingBlack(certificate, rateCurve, cSelect)
%function which computes the upfront using a Black 
%
%INPUT
...
%  _ Xc = value of the upfront 
    ...
    %% 
      ...
      %% Payoff
      [priceBlack,~] = priceDigital(cSelect, notional, optionPayoff, optionStrike, optionTTM, B_12(1));
      
      Expectation=priceBlack/B_12(1);
      
      Xc = (P_1 - B_12(1)*d1*certificate.coupons(1))*(1-Expectation)+...
